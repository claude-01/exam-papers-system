...
async function handleFormSubmit(event) {
    ...
    try {
        ...
        const url = editingId ? `${API_BASE}/api/admin/papers/${editingId}` : `${API_BASE}/api/admin/papers`;
...
async function toggleStatus(id) {
    ...
    try {
        const response = await fetch(`${API_BASE}/api/admin/papers/${id}`, {
            method: 'PUT',
            headers: {
...
async function confirmDelete() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE}/api/admin/papers/${paperToDelete}`, {
            method: 'DELETE',
            credentials: 'include'
        });
